# aqui onde criamos os métodos que vão usar ORM para manipular o banco de dados
...
def cadastrar_vaga(vaga):
    vaga_bd = Vaga.objects.create(titulo=vaga.titulo, descricao=vaga.descricao, salario=vaga.salario, tipo_contratacao=vaga.tipo_contratacao,
